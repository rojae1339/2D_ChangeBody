public class WeaponDTO
{
    ...
    public WeaponDTO(string weaponName, TierType tier, double attackDamage, double attackSpeed, AttackType weaponAttackType, double? bulletSpeed, double? reloadSpeed, int? maxBulletCount, int upgradeFleshCount, double partDropProbability)
    {
